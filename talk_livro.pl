...
%%%          clause should be interpreted as a query 
%%%          or assertion
%%%
...
%%% =====================
%%%
%%% Answers ==> nonempty list of answers to be printed to the standard 
...
print_answers([Answer|Rest]) :- 
	write(Answer), write(', '), print_answers(Rest).
...
% disallowed, since they cant form Horn clauses.
...
%%%
%%% Words are delimited by spaces and the line is ended by a newline. 
%%% Case is not folded; punctuation is not stripped.
%%%
%%%
...
%%% ===========
%%%
%%% Char === the ASCII code for the space characters
%%%
